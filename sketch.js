...
function preload(){
    ...
    batAnimation = loadAnimation("bat/bat1.png","bat/bat2.png","bat/bat3.png",
                        ...
                        "bat/bat10.png","bat/bat11.png","bat/bat12.png","Walking Frame/batman.png","Walking Frame/walking_4.png");
...
function draw(){
    ...
    if(frameCount % 1 === 0){
       bat.visible = true;
        bat.velocityX = Math.round(random(-20,4));
        bat.velocityY = Math.round(random(-4,20));
        bat.scale=0.4;
        bat.setLifeTime = 10;
